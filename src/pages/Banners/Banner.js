...
const Banner = () => {
          ...
          >
            <img
              onClick={() => {
                ...
                axios
                  .post(
                    "https://api.manjam.shop/v2/banner/updateHidden",
                    data_send
                  )
                  .then((res) => {
  ...
  const getbanners = () => {
    axios
      .get("https://api.manjam.shop/v2/banner/getAll?type=admin")
      .then((res) => {
  ...
  const handleeditbanner = () => {
    ...
    axios
      .post("https://api.manjam.shop/v2/banner/edit_banner", data_send)
      .then((res) => {
        if (res.data.status == 1) {
          toast.success(res.data.message);
          getbanners();
