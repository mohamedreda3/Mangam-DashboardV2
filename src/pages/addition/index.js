...
function Addition() {
  ...
  const addProduct = () => {
    ...
    axios
      .post("https://api.manjam.shop/v2/product/add_product", data_send)
      .then((res) => {
  ...
  const handleaddbanner = () => {
    ...
    axios
      .post("https://api.manjam.shop/v2/banner/add_banner", data_send)
      .then((res) => {
        // console.log(res)
        if (res.data.status == 1) {
          toast.success(res.data.message);
  ...
  const handleaddcategory = () => {
    ...
    // console.log(data_send);
    axios
      .post("https://api.manjam.shop/v2/category/add", data_send)
      .then((res) => {
        if (res.data.status == 1) {
          toast.success(res.data.message);
          window.location.reload();
