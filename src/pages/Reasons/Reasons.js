...
const Reasons = () => {
  ...
  const handledelete = (id) => {
    ...
    axios
      .post("https://api.manjam.shop/v2/reason/delete", data_send)
      .then((res) => {
        // console.log(res)
  ...
  const handleedit = () => {
    ...
    // console.log(data_send)
    axios
      .post("https://api.manjam.shop/v2/reason/edit", data_send)
      .then((res) => {
        // console.log(res.data);
        if (res.data.status == 1) {
          toast.success(res.data.message);
  ...
  const handleadd = () => {
    ...
    // console.log(data_send)
    axios
      .post("https://api.manjam.shop/v2/reason/add", data_send)
      .then((res) => {
        // console.log(res.data);
        if (res.data.status == 1) {
          toast.success(res.data.message);
